...
class GmailImapParser:
    ...
    def search_emails(
        self, search_criteria: str, use_uid: bool = True, verbose: bool = False
    ) -> List[bytes]:
        """
    ...
    def debug_search_comparison(
        ...
        try:
            ...
            return {
                ...
                "search_criteria_with_from": search_criteria_with_from
                if from_email
                else None,
    ...
    def fetch_emails_comprehensive(
        self,
        start_date: Optional[Union[datetime, str]] = None,
        end_date: Optional[Union[datetime, str]] = None,
        days: Optional[int] = None,
    ...
    def debug_all_emails_from_sender(
        self, from_email: str, limit: int = 20
    ) -> List[Dict]:
        """
    ...
    def search_all_gmail_folders(
        ...
        for folder in gmail_folders:
            try:
                ...
                search_criteria = self.get_search_criteria(
                    hours=hours, days=days, from_email=from_email
                )
        ...
        try:
            ...
            if status == "OK":
                ...
                for folder in folders:
                    ...
                    folder_str = (
                        folder.decode() if isinstance(folder, bytes) else str(folder)
                    )
